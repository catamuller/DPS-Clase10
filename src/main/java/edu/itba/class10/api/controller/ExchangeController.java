...
public class ExchangeController implements ExchangeApi {
    ...
    private final CurrencyConversionsHistory currencyConversionsHistory;
    ...
    public ResponseEntity<List<Conversion>> getAllConversions() {
        final var conversions = this.currencyConversionsHistory.getAllConversions()
                .stream()
                .map(this.singleConversionMapper::toConversion)
                .toList();
